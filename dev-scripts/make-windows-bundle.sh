...
# Bundles the RadekHLE9.9 executable with the basic set of files needed for
# RadekHLE9.9 to run (the same ones found in the macOS .app bundle or Android APK).
