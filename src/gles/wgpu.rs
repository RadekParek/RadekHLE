    ...
    fn new_with_backends(
        ...
        let (device, queue) = pollster::block_on(adapter.request_device(
            &wgpu::DeviceDescriptor {
                label: Some("RadekHLE9.0 WGPU presentation device"),
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("RadekHLE9.0 WGPU frame presenter"),
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(SHADER)),
        });
        let bind_group_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("RadekHLE9.0 WGPU frame bindings"),
            entries: &[
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("RadekHLE9.0 WGPU frame pipeline layout"),
        ...
        let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("RadekHLE9.0 WGPU frame pipeline"),
        ...
        let sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            label: Some("RadekHLE9.0 WGPU frame sampler"),
        ...
        let vertex_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("RadekHLE9.0 WGPU frame vertices"),
    ...
    pub fn present(&mut self, pixels: &[u8], width: u32, height: u32) -> Result<(), String> {
        ...
        if self.surface_input_size != (width, height) {
            let texture = self.device.create_texture(&wgpu::TextureDescriptor {
                label: Some("RadekHLE9.0 WGPU uploaded frame"),
                size: wgpu::Extent3d {
                    width,
                    height,
            ...
            let bind_group = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("RadekHLE9.0 WGPU uploaded frame bindings"),
        ...
        let mut encoder = self
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("RadekHLE9.0 WGPU frame encoder"),
            });
        {
            let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                label: Some("RadekHLE9.0 WGPU frame pass"),
    ...
    fn present_offscreen(&mut self, pixels: &[u8], width: u32, height: u32) -> Result<(), String> {
        ...
        if target_changed {
            let texture_desc = wgpu::TextureDescriptor {
                label: Some("RadekHLE9.0 WGPU offscreen frame target"),
                size: wgpu::Extent3d {
                    width,
                    height,
                    depth_or_array_layers: 1,
            ...
            self.offscreen_input = Some(self.device.create_texture(&wgpu::TextureDescriptor {
                label: Some("RadekHLE9.0 WGPU offscreen frame input"),
            ...
            let target_view = self
                ...
                .create_view(&wgpu::TextureViewDescriptor::default());
            let bind_group = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("RadekHLE9.0 WGPU offscreen frame bindings"),
                layout: &self.bind_group_layout,
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
        ...
        let mut encoder = self
            .device
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("RadekHLE9.0 WGPU offscreen frame encoder"),
            });
        {
            let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                label: Some("RadekHLE9.0 WGPU offscreen frame pass"),
                color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                    view: target_view,
                    resolve_target: None,
                    ops: wgpu::Operations {
