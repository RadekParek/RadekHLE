...
extern "C" {
    ...
    pub fn touchHLE_DynarmicA64Wrapper_clear_halt(cpu: *mut touchHLE_DynarmicWrapper, reason: u32);
    pub fn touchHLE_DynarmicA64Wrapper_set_trace(cpu: *mut touchHLE_DynarmicWrapper, enabled: bool);
