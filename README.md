...
RadekHLE9.1 is a community fork of [touchHLE](https://github.com/touchHLE/touchHLE), an HLE emulator for early iPhone OS applications. It keeps the upstream Rust architecture and adds Android, ARM64, graphics, and compatibility work.
...
RadekHLE9.1 builds on touchHLE and the open-source projects listed by the upstream project, including Dynarmic, SDL, OpenAL Soft, Symphonia, rust-macho, and the Rust ecosystem. See `--copyright` and the notices in the bundled libraries for the complete licence information.
